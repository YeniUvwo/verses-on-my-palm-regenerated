const CACHE='vomp-v8';
const ASSETS=['./','./index.html','./assets/css/style.css','./assets/data/verses.js','./assets/data/people.json','./assets/data/testimonies.json','./assets/js/app.js','./manifest.webmanifest','./assets/icons/icon.svg'];
